...
<div class="container-fluid">
    <div class="history-header">
        ...
        <div class="col-sm-2 text-right mt-2">
                <p>
                    <button type="button" class="btn btn-outline-primary btn-sm fs-5 float-end"  id="btnAddAccesories" data-toggle="tooltip" data-placement="bottom" title="Nuevo accesorio">
                        Nuevo
                        <a>
