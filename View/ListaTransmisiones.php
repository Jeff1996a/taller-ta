    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 text-right mt-2">
                <p>
                    <button type="button" class="btn btn-outline-primary btn-sm fs-5 float-end"  id="btnAddTransmision" data-toggle="tooltip" data-placement="bottom" title="Nueva transmisión">
                        Nuevo
                        <a>
