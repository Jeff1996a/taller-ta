        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 d-flex">
                    <div id="btnRegresar" class="btn btn-outline-warning" role="button" data-toggle="tooltip" data-placement="bottom" title="Regresar">
                ...
                <div class="col-md-2 d-flex justify-content-between text-right mt-3">
                    <p>
