        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 d-flex text-right mt-2">
                    <button  class=" btn-outline-success fs-6" role="button">
                        <a id="btnHistorial"  class="text-success text-end" data-toggle="tooltip" data-placement="bottom" title="Historial de mantenimiento">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-calendar-week float-start  me-2" viewBox="0 0 16 16">
