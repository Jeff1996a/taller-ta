            ...
            <div class="row">
                <div class="col-md-10 d-flex">
                    <div id="btnRegresar" role="button" data-toggle="tooltip" data-placement="bottom" title="Regresar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fa983a " class="bi bi-arrow-left-circle-fill mt-1" viewBox="0 0 16 16">
                ...
                <div class="col-md-2 d-flex text-right">
                    ...
                    <p class="fs-5">
                        ...
                        <a id="btnAccesorios" role="button" class="text-primary" data-toggle="tooltip" data-placement="bottom" title="Lista de accesorios">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-pci-card float-end" viewBox="0 0 16 16">
