            ...
            <div class="row">
                <div class="col-md-9 d-flex">
                    <div id="btnRegresar" class="text-warning" role="button" data-toggle="tooltip" data-placement="bottom" title="Regresar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-left-square-fill me-2 mt-3" viewBox="0 0 16 16">
                            <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"/>
                        </svg>
                    </div>
                    <h1 >Datos del equipo de: <?=$GLOBALS['category']?></h1>
                </div>
              
                
                <div class="col-md-3 d-flex justify-content-between text-right mt-3">
                    <p>
                        <button type="button"  class="btn btn-outline-success btn-sm fs-6 me-3" id="btnHistorial" data-toggle="tooltip" data-placement="bottom" title="Historial de mantenimiento" >
                            <a>
