            ...
            <div class="row">
                <div class="col-md-9 d-flex">
                    <div id="btnRegresar" role="button" data-toggle="tooltip" data-placement="bottom" title="Regresar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fa983a " class="bi bi-arrow-left-circle-fill mt-2" viewBox="0 0 16 16">
                ...
                <div class="col-md-3 d-flex text-right">
                    <p class="fs-5">
                        ...
                        <a id="btnHistorial" role="button" class="text-success text-end" data-toggle="tooltip" data-placement="bottom" title="Historial de mantenimiento">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-calendar-week float-end ms-2" viewBox="0 0 16 16">
                    ...
                    <p class="fs-5">
                        ...
                        <a id="btnAccesorios" role="button" class="text-primary" data-toggle="tooltip" data-placement="bottom" title="Lista de accesorios">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-pci-card float-end ms-2" viewBox="0 0 16 16">
