        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 d-flex text-right ">
                    <button type="button"  class="btn btn-outline-success fs-5" id="btnHistorial" data-toggle="tooltip" data-placement="bottom" title="Historial de mantenimiento" >
                        <a>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-week float-start  me-2" viewBox="0 0 16 16">
