...
<body>
	...
	<?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        	...
        	$sql = "SELECT * FROM usuarios WHERE nickname = '$usuario' AND password = MD5 ('$contrasena')";
        	...
        	if (mysqli_num_rows($rs) == 1) {
        		...
        		$sql2 = "UPDATE usuarios SET lastlogin = NOW() WHERE nickname = '$usuario'";
        		...
        		$sql3 = "SELECT * FROM usuarios WHERE nickname = '$usuario'";
